...
const act = [act1];
const dvd = new Dvd(2002, '1', 'sony', true, new Date(), DvdFormat.DVD);
const posterPath = '';
...
export const FILMS: Film[] = [
  new Film(1, titre, titre, _annee, true, real, act, genres, dvd, posterPath, alreadyInDvdtheque, tmdbId, runtime, homepage, Origine.DVD),
];
