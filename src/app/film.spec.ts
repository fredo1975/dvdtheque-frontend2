...
describe('Film', () => {
  it('should create an instance', () => {
    expect(new Film(1, titre, titre, _annee, true, real1, act, dvd, posterPath, alreadyInDvdtheque, tmdbId)).toBeTruthy();
  });
});

it('Film should accept values in the constructor', () => {
    const film = new Film(1, titre, titre, _annee, true, real1, act, dvd, posterPath, alreadyInDvdtheque, tmdbId);
